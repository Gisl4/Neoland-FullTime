...
// Crear mensaje en funcion si es privado o es publico
const MenssageSchema = new Schema(
  {
    ...
    recipientUser: { type: mongoose.Schema.Types.ObjectId, ref: "User" }, //toggel de mensajes
    likes: [{ type: mongoose.Schema.Types.ObjectId, ref: "User" }], //toggel
  },
  {
    timestamps: true,
  }
...
//los menajes de ordenan por tiempo de como se fueron enviando
